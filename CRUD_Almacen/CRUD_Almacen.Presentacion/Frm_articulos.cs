...
namespace CRUD_Almacen.Presentacion
{
    public partial class Frm_articulos : Form
    {
        ...
        {
            Txt_descripcion_art.ReadOnly = !lEstado;
            Txt_marca_art.ReadOnly = !lEstado;
        ...
        private void Limpia_texto()
        {
            ...
            Txt_marca_art.Text = "";
            Txt_descripcion_unidad_medida.Text = "";
            Txt_descripcion_cat.Text = "";
        ...
        private void Selecciona_item()
        {
            ...
            }else
            {
                ...
                Txt_descripcion_art.Text = Convert.ToString(Dgv_articulos.CurrentRow.Cells["descripcion_ar"].Value);
                Txt_marca_art.Text = Convert.ToString(Dgv_articulos.CurrentRow.Cells["marca_ar"].Value);
                Txt_descripcion_unidad_medida.Text = Convert.ToString(Dgv_articulos.CurrentRow.Cells["descripcion_um"].Value);
                Txt_descripcion_cat.Text = Convert.ToString(Dgv_articulos.CurrentRow.Cells["descripcion_ca"].Value);
        ...
        private void Selecciona_item_um()
        {
            ...
            else
            {
                ...
                Txt_descripcion_unidad_medida.Text = Convert.ToString(Dgv_um.CurrentRow.Cells["descripcion_um"].Value);
            }
        }
        private void Selecciona_item_ca()
        {
            ...
            else
            {
                ...
                Txt_descripcion_cat.Text = Convert.ToString(Dgv_ca.CurrentRow.Cells["descripcion_ca"].Value);
            }
        }
                #endregion
        ...
        private void Txt_descripcion_art_TextChanged(object sender, EventArgs e)
        {
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            oAr.Descripcion_ar = Txt_descripcion_art.Text.Trim();
            oAr.Marca_ar = Txt_marca_art.Text.Trim();
